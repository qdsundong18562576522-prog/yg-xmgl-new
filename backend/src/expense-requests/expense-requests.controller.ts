...
export class ExpenseRequestsController {
  constructor(private service: ExpenseRequestsService) {}
  ...
  @Post() async create(@Body() dto: CreateExpenseRequestDto, @CurrentUser() user: any) { return this.service.create(dto, user.userId); }
